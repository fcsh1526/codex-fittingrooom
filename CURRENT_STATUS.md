...
The five W29 v3 Canva duplicates were initially filled on 2026-07-16, but visual review found that generic narrow portrait sources were center-cover cropped by Canva's exact frames. W29-001 has now completed the corrected path: A/B/C were purpose-built for v3-B at `1240x1350`, `1140x560`, and `1180x1350`, visually reviewed in Canva, approved by the user, and saved. W29-001 is `ready_for_manual_export`; W29-002 through W29-005 remain `needs_visual_revision`. Old W29 v2 selections must not be used for new Canva work.
...
W29-001 correctly resolves to v3-B: A `1240x1350`, B `1140x560`, C `1180x1350`. The accepted A source required an 8.15% center crop; native-ratio B and C required only 0.02% and 0.09%. The saved Canva design preserves complete hair and faces, keeps the outfit focus visible, and shows the full `MIRA` mark. Next production item is W29-002 using its assigned v3-E slot geometry.
