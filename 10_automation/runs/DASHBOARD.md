...
| `2026-W29` | `needs_image_asset_selection` | `pass` | `1/5` | `False` | `0` | Continue generating and scoring the remaining Codex image jobs, then rerun select_codex_assets.py. Canva work for already selected carousels can proceed in parallel. |
