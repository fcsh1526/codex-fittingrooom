...
| `2026-W29` | `needs_visual_revision` | `pass` | `5/5` | `False` | `0` | Read canva_slot_targets.json, create A/B/C for the assigned master frame ratios, normalize them without stretching, and do not publish until the untouched Canva fill and canva_frame_fit pass. |
