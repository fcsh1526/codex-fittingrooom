...
| `2026-W27` | `needs_image_asset_selection` | `pass` | `0/5` | `False` | `0` | Fill the image review template after reviewing Codex outputs, then rerun select_codex_assets.py with that score sheet. |
