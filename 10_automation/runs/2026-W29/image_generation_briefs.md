...
- Outfit: 透膚網紗長袖上衣 ＋ 緞面細肩帶背心 ＋ 寬褲
- Palette / fabric / fit: mist gray + cream / mesh + satin / slim top / relaxed bottom
- Occasion: 通勤
- Scene: clean studio with soft daylight, minimal props
...
Outfit: 透膚網紗長袖上衣 ＋ 緞面細肩帶背心 ＋ 寬褲; palette mist gray + cream; fabric mesh + satin; fit slim top / relaxed bottom.
...
Scene: clean studio with soft daylight, minimal props. Make it feel like a believable Taiwan daily-life moment, not a runway or brand advertisement.
...
Composition: full outfit readable within one second, natural posture, subtle real skin texture, edge-to-edge 4:5 environment, crown-to-sole figure occupying about 78-82% of frame height, both shoes and floor contact visible, no visible logos, no text, no watermark.
...
## 2026-W29-002 / M02 - 浪漫波西米亞（蕾絲、流蘇與刺繡）
...
- Outfit: 蕾絲滾邊細肩帶背心 ＋ 亞麻寬褲 ＋ 編織包
- Palette / fabric / fit: ivory + sand / cotton lace + linen / relaxed
- Occasion: 旅行
- Scene: clean studio with soft daylight, minimal props
...
Prompt visual age language: late 20s, youthful.
Express age through styling and presence, NOT wrinkles. East Asian women look significantly younger than Western age norms. Skin is smooth and well-maintained.
Outfit: 蕾絲滾邊細肩帶背心 ＋ 亞麻寬褲 ＋ 編織包; palette ivory + sand; fabric cotton lace + linen; fit relaxed.
Styling rules: keep outfit logo-free; emphasize material texture and layered styling; balanced proportions (fitted top + volume bottom or vice versa).
Scene: clean studio with soft daylight, minimal props. Make it feel like a believable Taiwan daily-life moment, not a runway or brand advertisement.
Outfit continuity: A/B/C are the same outfit session. Lock every garment, layer, color, shoe, bag, jewelry item, and styling placement; vary only lateral position, body angle, pose, gaze, hand interaction, and expression.
Body proportion lock: match the approved full-body anchor's head-to-height ratio, shoulder width, torso length, natural waist and hip placement, crotch height, knee height, thigh length, lower-leg length, arm length, and hand size. Do not shrink the head, raise the crotch, narrow the torso, or lengthen the legs.
...
## 2026-W29-003 / M04 - 未完成剪裁與解構西裝（外露車線與不對稱）
...
- Outfit: 解構西裝外套 ＋ 透膚上衣 ＋ 直筒長褲
- Palette / fabric / fit: charcoal + mist gray / suiting + mesh / relaxed blazer
- Occasion: 展覽
- Scene: clean studio with soft daylight, minimal props
...
Prompt visual age language: early 40s look, elegant.
Express age through styling and presence, NOT wrinkles. East Asian women look significantly younger than Western age norms. Skin is smooth and well-maintained.
Outfit: 解構西裝外套 ＋ 透膚上衣 ＋ 直筒長褲; palette charcoal + mist gray; fabric suiting + mesh; fit relaxed blazer.
Styling rules: keep outfit logo-free; emphasize material texture and layered styling; balanced proportions (fitted top + volume bottom or vice versa).
Scene: clean studio with soft daylight, minimal props. Make it feel like a believable Taiwan daily-life moment, not a runway or brand advertisement.
Outfit continuity: A/B/C are the same outfit session. Lock every garment, layer, color, shoe, bag, jewelry item, and styling placement; vary only lateral position, body angle, pose, gaze, hand interaction, and expression.
Body proportion lock: match the approved full-body anchor's head-to-height ratio, shoulder width, torso length, natural waist and hip placement, crotch height, knee height, thigh length, lower-leg length, arm length, and hand size. Do not shrink the head, raise the crotch, narrow the torso, or lengthen the legs.
...
## 2026-W29-004 / M03 - 鬆弛實用輪廓（氣球褲與寬量感下身）
...
- Outfit: 氣球版型牛仔褲 ＋ 合身背心 ＋ 短版西裝外套
- Palette / fabric / fit: denim + black / denim + cotton / high-waist barrel
- Occasion: 通勤
- Scene: clean studio with soft daylight, minimal props
...
Prompt visual age language: mid 30s look, well-maintained.
Express age through styling and presence, NOT wrinkles. East Asian women look significantly younger than Western age norms. Skin is smooth and well-maintained.
Outfit: 氣球版型牛仔褲 ＋ 合身背心 ＋ 短版西裝外套; palette denim + black; fabric denim + cotton; fit high-waist barrel.
Styling rules: keep outfit logo-free; emphasize material texture and layered styling; balanced proportions (fitted top + volume bottom or vice versa).
Scene: clean studio with soft daylight, minimal props. Make it feel like a believable Taiwan daily-life moment, not a runway or brand advertisement.
Outfit continuity: A/B/C are the same outfit session. Lock every garment, layer, color, shoe, bag, jewelry item, and styling placement; vary only lateral position, body angle, pose, gaze, hand interaction, and expression.
Body proportion lock: match the approved full-body anchor's head-to-height ratio, shoulder width, torso length, natural waist and hip placement, crotch height, knee height, thigh length, lower-leg length, arm length, and hand size. Do not shrink the head, raise the crotch, narrow the torso, or lengthen the legs.
...
## 2026-W29-005 / M05 - 中性色彩亮點（薄荷綠、奶油黃與原色）
...
- Outfit: 奶油黃開襟衫 ＋ 白色背心 ＋ 寬褲
- Palette / fabric / fit: butter yellow + cream / fine knit + linen / relaxed
- Occasion: 辦公室
- Scene: clean studio with soft daylight, minimal props
...
Prompt visual age language: around 20, youthful adult.
Express age through styling and presence, NOT wrinkles. East Asian women look significantly younger than Western age norms. Skin is smooth and well-maintained.
Outfit: 奶油黃開襟衫 ＋ 白色背心 ＋ 寬褲; palette butter yellow + cream; fabric fine knit + linen; fit relaxed.
Styling rules: keep outfit logo-free; emphasize material texture and layered styling; balanced proportions (fitted top + volume bottom or vice versa).
Scene: clean studio with soft daylight, minimal props. Make it feel like a believable Taiwan daily-life moment, not a runway or brand advertisement.
Outfit continuity: A/B/C are the same outfit session. Lock every garment, layer, color, shoe, bag, jewelry item, and styling placement; vary only lateral position, body angle, pose, gaze, hand interaction, and expression.
Body proportion lock: match the approved full-body anchor's head-to-height ratio, shoulder width, torso length, natural waist and hip placement, crotch height, knee height, thigh length, lower-leg length, arm length, and hand size. Do not shrink the head, raise the crotch, narrow the torso, or lengthen the legs.
